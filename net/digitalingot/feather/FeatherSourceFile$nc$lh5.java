...
public final class FeatherSourceFile$nc$lh5 extends StructBuilder {
   FeatherSourceFile$nc$lh5(SegmentBuilder var1, int var2, int var3, int var4, short var5) {
      super(var1, var2, var3, var4, var5);
   }

   public final FeatherSourceFile$nc$xj oE() {
      return new FeatherSourceFile$nc$xj(this.segment, this.data, this.pointers, this.dataSize, this.pointerCount, Integer.MAX_VALUE);
   }
