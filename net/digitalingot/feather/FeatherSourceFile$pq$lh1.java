...
public final class FeatherSourceFile$pq$lh1 extends StructBuilder {
   FeatherSourceFile$pq$lh1(SegmentBuilder var1, int var2, int var3, int var4, short var5) {
      super(var1, var2, var3, var4, var5);
   }

   public final FeatherSourceFile$pq$xj1 kU() {
      return new FeatherSourceFile$pq$xj1(this.segment, this.data, this.pointers, this.dataSize, this.pointerCount, Integer.MAX_VALUE);
   }
