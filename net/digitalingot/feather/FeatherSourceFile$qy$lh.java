...
public final class FeatherSourceFile$qy$lh extends StructBuilder {
   FeatherSourceFile$qy$lh(SegmentBuilder var1, int var2, int var3, int var4, short var5) {
      super(var1, var2, var3, var4, var5);
   }

   public final FeatherSourceFile$qy$xj kL() {
      return new FeatherSourceFile$qy$xj(this.segment, this.data, this.pointers, this.dataSize, this.pointerCount, Integer.MAX_VALUE);
   }
