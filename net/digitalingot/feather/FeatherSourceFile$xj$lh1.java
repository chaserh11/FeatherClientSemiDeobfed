...
public final class FeatherSourceFile$xj$lh1 extends StructBuilder {
   FeatherSourceFile$xj$lh1(SegmentBuilder var1, int var2, int var3, int var4, short var5) {
      super(var1, var2, var3, var4, var5);
   }

   public final FeatherSourceFile$xj$xj oF() {
      return new FeatherSourceFile$xj$xj(this.segment, this.data, this.pointers, this.dataSize, this.pointerCount, Integer.MAX_VALUE);
   }
