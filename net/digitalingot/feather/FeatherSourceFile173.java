...
public class FeatherSourceFile173 extends TypeAdapter {
   public void lh(JsonWriter var1, Color var2) {
      if (var2 == null) {
         var1.nullValue();
      } else {
         var1.beginObject();
   ...
   public Color oe(JsonReader var1) {
      var1.beginObject();
      Color var2 = null;
