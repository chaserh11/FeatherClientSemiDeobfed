...
@Singleton
public class FeatherSourceFile782 implements FeatherSourceFile594 {
   private final Provider jM;
   private final FeatherSourceFile665 hb;
   private final FeatherSourceFile207 hf;

   @Inject
   FeatherSourceFile782(Provider var1, FeatherSourceFile665 var2, FeatherSourceFile207 var3) {
      this.jM = var1;
      this.hb = var2;
      this.hf = var3;
   }

   public void lh(FeatherSourceFile210 var1, Consumer var2, Consumer var3) {
   ...
   public FeatherSourceFile754 hc() {
      return FeatherSourceFile754.RESET_MOD_SETTINGS;
   }
}
